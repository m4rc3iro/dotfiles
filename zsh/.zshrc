...
alias gststaged="git status --short | grep '^\w'"
alias gstunstaged="git status  --short | grep '^\W'"
alias gstunstaged-tracked="git status  --short | grep '^\s'"
alias gstuntracked="git status --short | grep '^??'"
...
alias wcon='f() { nmcli device wifi connect $1 password $2 };f'
alias wconh1='nmcli device wifi connect UPC8507569 password WW72yavuktmp'
alias wconh2='nmcli device wifi connect UPC8507569_EXT password WW72yavuktmp'
...
# fix to enable 'Suprimir' (fn + DELETE)
